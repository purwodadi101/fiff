...
gotop_url="https://raw.githubusercontent.com/carntea3/zxt/main/gotop"
...
wget --no-check-certificate -O /opt/bbr.sh https://raw.githubusercontent.com/carntea3/zxt/main/bbr.sh
